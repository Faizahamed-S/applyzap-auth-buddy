  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <p className="text-sm font-semibold text-gray-900 truncate flex-1 capitalize">{job.companyName}</p>
        <button
      ...
      <p className="text-xs text-gray-500 truncate mt-1.5 capitalize">{job.roleName}</p>
