...
export interface JobApplication {
  id: string;
  /** Read-only, per-user application identifier generated by the backend. */
  userJobId?: number;
  companyName: string;
  roleName: string;
...
export interface CreateJobApplication extends Omit<JobApplication, 'id' | 'userJobId'> {}

export interface UpdateJobApplication extends Partial<Omit<JobApplication, 'id' | 'userJobId'>> {}
